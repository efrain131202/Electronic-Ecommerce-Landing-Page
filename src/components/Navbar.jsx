...
function Navbar() {
    return (
        <nav className="bg-white py-[70px] px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4 sm:space-x-6">
                ...
                <a href="/signup" className="flex items-center text-white text-[12px] sm:text-base font-medium bg-black px-6 sm:px-8 py-2 sm:py-3 rounded-full hover:bg-gray-800 transition-colors duration-300">
...
function NavLink({ href, children }) {
    return (
        <a href={href} className="text-gray-500 text-[12px] sm:text-[13px] hover:text-[#5e1ee5] transition-colors duration-300">
            {children}
        </a>
    );
}
